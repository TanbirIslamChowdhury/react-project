...
function Home() {
    ...
    useEffect(() => {
      ...
      const getDatas = async (e) => {
         let feat = await axios.get(`front-api/technicians.php`)
  ...
  return (
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 pt-4" style={{minHeight: '500px'}}>
                    <div class="position-relative h-100 wow fadeInUp" data-wow-delay="0.5s">
                        <img class="position-absolute img-fluid w-100 h-100" src="assets/img/about-1.jpg" style={{objectFit: 'cover', padding: '0 0 50px 100px'}} alt=""/>
                        <img class="position-absolute start-0 bottom-0 img-fluid bg-white pt-2 pe-2 w-50 h-50" src="assets/img/about-2.jpg" style={{objectFit: 'cover'}} alt=""/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                {technicians.length > 0 && technicians.map((d,k)=>
                    <div key={d.id} class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid" src={`${process.env.REACT_APP_API_URL}${d.image}`} alt=""/>
                            </div>
                            <div class="team-text">
                                <div class="bg-light">
